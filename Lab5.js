...
const todos = [
    ...
    { id: "2", title: "Task 1", description: "Task 1 description", due: "", completed: false },
    { id: "3", title: "Task 2", description: "Task 2 description", due: "", completed: true },
    { id: "4", title: "Task 3", description: "Task 3 description", due: "", completed: false },
    { id: "5", title: "Task 4", description: "Task 4 description", due: "", completed: true },
];
...
const Lab5 = (app) => {
    ...
    app.get("/a5/assignment/complete", (req, res) => {
